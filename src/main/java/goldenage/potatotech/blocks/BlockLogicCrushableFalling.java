...
public class BlockLogicCrushableFalling extends BlockLogicFallingBlock {
	public String oreOutput;

	public BlockLogicCrushableFalling(Block<?> block, Material material, String oreOutput) {
